...
class BamlSyncClient:
    ...
    def ExtractOcrBatch(self, page_images: typing.List[baml_py.Image],
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractOcrBatch", args={
...
class BamlStreamClient:
    ...
    def ExtractOcrBatch(self, page_images: typing.List[baml_py.Image],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[typing.List["stream_types.OcrPageResult"], typing.List["types.OcrPageResult"]]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractOcrBatch", args={
            "page_images": page_images,
        })
        return baml_py.BamlSyncStream[typing.List["stream_types.OcrPageResult"], typing.List["types.OcrPageResult"]](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ExtractOcrBatch(self, page_images: typing.List[baml_py.Image],
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractOcrBatch", args={
            "page_images": page_images,
        }, mode="request")
        return __result__
    def FillSchema(self, document_text: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="FillSchema", args={
            "document_text": document_text,
        }, mode="request")
        return __result__
